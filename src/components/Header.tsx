      ...
      <div className="max-w-7xl mx-auto px-4">
        <div className="flex justify-between items-center py-4">
          <div className="flex items-center">
            <Tooltip content="Volver al Inicio" position="bottom">
              <Link to="/">
          ...
          <div className="hidden lg:flex items-center space-x-6">
            <Tooltip content="Únete a nuestro servidor FiveM" position="bottom">
            ...
            <Tooltip content="Únete a nuestro Discord" position="bottom">
            ...
            <Tooltip content="Visita nuestra tienda" position="bottom">
